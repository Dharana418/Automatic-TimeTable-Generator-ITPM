        ...
        <section style={{
          ...
          <form onSubmit={handleAddModule} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 16 }}>
              <DarkInput label="Academic Year" val={form.academic_year} onChange={v => setForm(p => ({...p, academic_year: v}))} type="number" />
              <DarkInput label="Semester" val={form.semester} onChange={v => setForm(p => ({...p, semester: v}))} type="number" />
              <DarkInput label="Credits" val={form.credits} onChange={v => setForm(p => ({...p, credits: v}))} type="number" />
              <DarkInput label="Lectures / Week" val={form.lectures_per_week} onChange={v => setForm(p => ({...p, lectures_per_week: v}))} type="number" />
            </div>
