...
const Footer = ({ isAuthenticated, user, hasFixedSidebarOffset = false }) => {
    ...
    return (
        <footer className={`relative z-30 mt-auto border-t border-sky-700 bg-gradient-to-r from-sky-700 via-sky-600 to-cyan-600 text-white transition-all duration-300 ${shouldOffsetForSidebar ? 'lg:pl-[260px]' : ''}`}>
            <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-sky-100/80 to-transparent" />
            ...
            <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4 lg:gap-12">
                    ...
                    <div className="col-span-1 md:col-span-1 lg:col-span-2">
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                            <span className="inline-flex items-center gap-1 rounded-full border border-sky-200/60 bg-white/15 px-3 py-1 text-xs font-semibold text-white">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            <li>
                                <Link to="/dashboard" className="group flex w-max items-center text-sm font-medium text-slate-200 transition-colors hover:text-white">
                            ...
                            <li>
                                <Link to="/scheduler" className="group flex w-max items-center text-sm font-medium text-slate-200 transition-colors hover:text-white">
                                    <span className="relative overflow-hidden">
                                        Advanced Scheduler
                                        <span className="absolute bottom-0 left-0 h-[1.5px] w-full origin-left -translate-x-full bg-white transition-transform duration-300 group-hover:translate-x-0"></span>
                                    </span>
                            ...
                            <li>
                                <Link to="/profile" className="group flex w-max items-center text-sm font-medium text-slate-200 transition-colors hover:text-white">
                                    <span className="relative overflow-hidden">
                                        My Profile
                                        <span className="absolute bottom-0 left-0 h-[1.5px] w-full origin-left -translate-x-full bg-white transition-transform duration-300 group-hover:translate-x-0"></span>
                                    </span>
                            ...
                            <li>
                                <a href="#" className="group flex w-max items-center text-sm font-medium text-slate-200 transition-colors hover:text-white">
                                    <span className="relative overflow-hidden">
                                        Documentation
                                        <span className="absolute bottom-0 left-0 h-[1.5px] w-full origin-left -translate-x-full bg-white transition-transform duration-300 group-hover:translate-x-0"></span>
                                    </span>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-4">
                            <li className="flex items-start gap-3 text-sm font-medium text-slate-200">
                                <MapPin className="mt-0.5 h-5 w-5 shrink-0 text-sky-100" />
                            ...
                            <li className="flex items-center gap-3 text-sm font-medium text-slate-200">
                                <Phone className="h-5 w-5 shrink-0 text-sky-100" />
                                <a href="tel:+94117544801" className="transition-colors hover:text-white">+94 11 754 4801</a>
                            </li>
                            <li className="flex items-center gap-3 text-sm font-medium text-slate-200">
                                <Mail className="h-5 w-5 shrink-0 text-sky-100" />
                ...
                {/* Bottom Bar */}
                <div className="mt-12 flex flex-col items-center justify-between border-t border-sky-100/35 pt-8 md:flex-row">
                            <p className="text-sm font-medium text-slate-200">
                        &copy; {currentYear} SLIIT Scheduler. All rights reserved.
                    </p>
                    <div className="mt-4 flex space-x-6 md:mt-0">
                                <a href="#" className="text-sm font-medium text-slate-200 transition-colors hover:text-white">Privacy Policy</a>
                                <a href="#" className="text-sm font-medium text-slate-200 transition-colors hover:text-white">Terms of Service</a>
                                <a href="#" className="text-sm font-medium text-slate-200 transition-colors hover:text-white">Cookie Settings</a>
                    </div>
                </div>
            </div>
            ...
            <button
                ...
                className={`fixed bottom-6 right-5 z-[70] inline-flex items-center gap-1.5 rounded-full border border-sky-200/70 bg-sky-700/95 px-4 py-2 text-xs font-bold uppercase tracking-wide text-white shadow-[0_12px_28px_rgba(3,105,161,0.45)] backdrop-blur transition-all duration-300 hover:-translate-y-0.5 hover:border-sky-100 hover:bg-sky-600 ${shouldOffsetForSidebar ? 'lg:right-6' : ''} ${showBackToTop ? 'opacity-100 translate-y-0' : 'pointer-events-none opacity-0 translate-y-3'}`}
            >
